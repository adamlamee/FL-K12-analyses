...
do
echo "***  " >> ${file}
echo -e "<a href=\"../District_plots/${i}_11BCPtrend.png\"><img src=\"../District_plots/${i}_11BCPtrend.png\" width=\"200\"></a><a href=\"../District_plots/${i}_12courses.png\"><img src=\"../District_plots/${i}_12courses.png\" width=\"200\"><a/>  " >> ${file}
