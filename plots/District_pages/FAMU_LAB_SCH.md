...
Plots for [individual schools in Famu_Lab_Sch](./FAMU_LAB_SCH_schools.md) can be viewed [here](./FAMU_LAB_SCH_schools.md) (see notes about the data and the end of this page).  See the plots for [each of Florida's districts and lab schools here](./all_districts.md). 
<a href="../District_plots/FAMU_LAB_SCH_11BCPtrend.png"><img src="../District_plots/FAMU_LAB_SCH_11BCPtrend.png"></a>  
Questions to ask:  
...
<a href="../District_plots/FAMU_LAB_SCH_12courses.png"><img src="../District_plots/FAMU_LAB_SCH_12courses.png"></a>  
Questions to ask:  
