...
Plots for [individual schools in Holmes](./HOLMES_schools.md) can be viewed [here](./HOLMES_schools.md) (see notes about the data and the end of this page).  See the plots for [each of Florida's districts and lab schools here](./all_districts.md). 
<a href="../District_plots/HOLMES_11BCPtrend.png"><img src="../District_plots/HOLMES_11BCPtrend.png"></a>  
Questions to ask:  
...
<a href="../District_plots/HOLMES_12courses.png"><img src="../District_plots/HOLMES_12courses.png"></a>  
Questions to ask:  
